...
public class QueryResultVerticalPanel extends Panel {
	...
	ListView<CqlExtendedColumnName> columnList = new ListView<CqlExtendedColumnName>(
		...
		ListView<Row> columnValueList = new ListView<Row>("columnValueList", new RowsModel(
			displayedRows)) {
	...
	public void updateResult(CqlQueryResult result) {
		...
		allColumnsBuild.add(new CqlExtendedColumnName(CqlColumnType.SEPARATOR, CqlDataType
