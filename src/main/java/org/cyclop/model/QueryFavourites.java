...
public final class QueryFavourites implements Serializable, Synchronizable {
    ...
    /**
     * @return true if add was successful, otherwise false - meaning that size
     *         limit is reached. Already existing elements can be always
     *         replaced - update change date
     */
