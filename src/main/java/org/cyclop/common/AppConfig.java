...
public class AppConfig implements Serializable {
	...
	@Inject
	protected CqlEditor(
		@Value("${cqlEditor.rowsPerPage}") int rowsPerPage,
	...
	@Override
	public String toString() {
	    return "CqlEditor [rowsPerPage="
		    + rowsPerPage
		    + ", maxColumnEmbeddedDisplayChars="
		    + maxColumnEmbeddedDisplayChars
	...
	@Inject
	public CqlExport(
		@Value("${cqlExport.fileName}") String fileName,
	...
	@Override
	public String toString() {
	    return "CqlExport [querySeparator="
		    + querySeparator
		    + ", rowSeparator="
		    + rowSeparator
		    + ", listSeparator="
