...
class QueryServiceImpl implements QueryService {
    ...
    private CqlPartitionKey collectAndCountColumns(
	    Row row,
	    Map<CqlExtendedColumnName, MutableInt> columnsCount,
	...
	for (int colIndex = 0; colIndex < definitions.size(); colIndex++) {
	    ...
	    CqlExtendedColumnName columnName = new CqlExtendedColumnName(
		    columnType,
		    CqlDataType.create(dataType),
		    columnNameText);
    ...
    protected void loadPartitionKeyNames(
	    CqlTable table,
