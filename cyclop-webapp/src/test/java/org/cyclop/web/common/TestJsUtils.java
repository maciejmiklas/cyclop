...
public class TestJsUtils {
	...
	assertEquals("[\"col 1\",\"col 1231\",\"2col 41\"]", JsUtils.escapeArray(ImmutableSet.of(
		new CqlColumnName("col 1"),
		new CqlColumnName("col 1"),
		new CqlColumnName("col 1231"),
	...
	assertEquals(
		"[\"123123\",\"param two\"]",
		JsUtils.escapeStrArray(ImmutableSet.of("123123", "param two")));
    }
