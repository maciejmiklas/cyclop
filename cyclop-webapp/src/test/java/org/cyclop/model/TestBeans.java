...
public class TestBeans extends AbstractTestCase {
	...
	extendedColumnBuild.add(new CqlExtendedColumnName(CqlColumnType.COMPACT_VALUE, CqlDataType
		.create(DataType.bigint()), "col"));
	extendedColumnBuild.add(new CqlExtendedColumnName(CqlColumnType.PARTITION_KEY, CqlDataType
		.create(DataType.inet()), "col 2"));

	CqlRowMetadata obj = new CqlRowMetadata(
		extendedColumnBuild.build(),
	...
	CqlExtendedColumnName obj = new CqlExtendedColumnName(
	...
	obj.addWithSizeCheck(new QueryEntry(new CqlQuery(
		CqlQueryType.ALTER_TABLE,
		"alter cqldemo.mybooks ...."), DateTime.now(), 2312));
	obj.addWithSizeCheck(new QueryEntry(new CqlQuery(
		CqlQueryType.ALTER_KEYSPACE,
		"alter sapce cqldemo.mybooks ...."), DateTime.now(), 234));
	obj.addWithSizeCheck(new QueryEntry(
		new CqlQuery(CqlQueryType.SELECT, "select * from cqldemo.mybooks"),
		DateTime.now(),
		345));
	...
	des.addWithSizeCheck(new QueryEntry(
		new CqlQuery(CqlQueryType.SELECT, "select * from cqldemo.mybooks"),
		DateTime.now(),
		542));
    }
	...
	obj.add(new QueryEntry(new CqlQuery(CqlQueryType.ALTER_TABLE, "alter cqldemo.mybooks ...."), DateTime
		.now(), 23));
	obj.add(new QueryEntry(
		new CqlQuery(CqlQueryType.ALTER_KEYSPACE, "alter sapce cqldemo.mybooks ...."),
		DateTime.now(),
		7654));
	obj.add(new QueryEntry(new CqlQuery(CqlQueryType.SELECT, "select * from cqldemo.mybooks"), DateTime
		.now(), 987656));
	...
	QueryEntry obj = new QueryEntry(
		new CqlQuery(CqlQueryType.ALTER_TABLE, "alter cqldemo.mybooks ...."),
		DateTime.now(),
		1231);
	...
	et.addEqualityGroup();
	et.addEqualityGroup(new CqlExtendedColumnName(
	...
	et.addEqualityGroup(new CqlExtendedColumnName(
		...
		CqlDataType.TEXT,
		"cqldemo.mybooks"));
	et.addEqualityGroup(new CqlExtendedColumnName(CqlColumnType.CLUSTERING_KEY, CqlDataType
		.create(DataType.ascii()), "cqldemo.mybooks"));
	...
	et.addEqualityGroup(new CqlPartitionKey(CqlDataType.TEXT, "cqldemo.mybooks"), CqlPartitionKey
	...
	et.addEqualityGroup(new QueryEntry(
		new CqlQuery(CqlQueryType.ALTER_KEYSPACE, "cqldemo.mybooks"),
		34523), new QueryEntry(
		new CqlQuery(CqlQueryType.ALTER_KEYSPACE, "cqldemo.mybooks"),
		new DateTime(),
		2465245));
	...
	et.addEqualityGroup(new CqlColumnValue(Long.class, new Long(11), new CqlExtendedColumnName(
		CqlColumnType.CLUSTERING_KEY,
		CqlDataType.TEXT,
		"testcol")), new CqlColumnValue(Long.class, 11L, new CqlExtendedColumnName(
		CqlColumnType.CLUSTERING_KEY,
		CqlDataType.TEXT,
		"testcol")));
	et.testEquals();
