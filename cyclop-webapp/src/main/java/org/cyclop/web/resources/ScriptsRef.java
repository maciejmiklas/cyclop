...
public final class ScriptsRef {
    ...
    public static final JavaScriptResourceReference JQUERY_TOOLS = new JavaScriptResourceReference(
	    ScriptsRef.class,
    ...
    public static final JavaScriptResourceReference JQUERY_UI = new JavaScriptResourceReference(
	    ScriptsRef.class,
