...
public class ButtonsPanel extends Panel {
    ...
    private static final JavaScriptResourceReference JS_BUTTONS = new JavaScriptResourceReference(
	    ButtonsPanel.class,
	    "buttons.js");
	...
	AjaxFallbackLink<Void> completion = new IconButton(
		"resultOrientation",
		initialState,
	...
	AjaxFallbackLink<Void> completion = new StateButton(
		"completion",
		completionEnabled,
