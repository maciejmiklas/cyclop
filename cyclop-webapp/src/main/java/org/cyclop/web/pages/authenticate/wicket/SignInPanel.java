package org.cyclop.web.pages.authenticate.wicket;
...
// orginal class coped from wicket extensions with changed visibility of signIn(...,...)
/**
...
public class SignInPanel extends Panel {
	...
	public SignInPanel(final String id, final boolean includeRememberMe) {
		...
		signInForm = new SignInForm(SIGN_IN_FORM);
		add(signInForm);
	}
