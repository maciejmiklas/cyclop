...
public final class UserPreferences implements Serializable {
	...
	return Objects.toStringHelper(this).add("showCqlCompletionHint", showCqlCompletionHint)
		...
		.add("importContinueWithErrors", importContinueWithErrors)
		.add("pagerEditorItems", pagerEditorItems).add("pagerHistoryItems", pagerHistoryItems)
		.add("pagerImportItems", pagerImportItems).add("resultOrientation", resultOrientation)
		.toString();
    }
	...
	return java.util.Objects.hash(
		showCqlCompletionHint,
		showCqlHelp,
		importIncludeInHistory,
		importContinueWithErrors,
		pagerEditorItems,
		pagerHistoryItems,
		pagerImportItems,
		importParallel,
